...
namespace SDE.Databases.Generic.Common {
	...
	public static class JobTypeInfo {
		public const string Marker = "JT_";
		...
		static JobTypeInfo() {
			foreach (var value in Enum.GetValues(typeof(JobType))) {
				All.Add(new EnumInfoBase((JobType)value, value.ToString(), Marker));
			}
			...
			EnumInfos.Add<JobType>(All, TypeToInfo, Marker);
		}
	}
}
